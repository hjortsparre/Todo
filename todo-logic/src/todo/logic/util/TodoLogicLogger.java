...
public class TodoLogicLogger {
	...
	private static final Logger logger = Logger.getLogger(TodoLogicLogger.class
			.getName());
	...
	static {
		try {
			...
			FileHandler fileHandler = new FileHandler(logPath
					+ TodoLogicLogger.class.getSimpleName() + ".log.html", true);
